...
\def\titleOffset{3cm}
\tikzstyle{insideBoxStyle} = [cyan, fill=white, text=black, ultra thick, rectangle, draw, rounded corners=2cm, inner sep=10pt, inner ysep=20pt, text width=\insideBoxWidth]
